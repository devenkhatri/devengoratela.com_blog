...
[<img src="https://www.gatsbyjs.com/deploynow.png" alt="Deploy to Gatsby Cloud">](https://www.gatsbyjs.com/dashboard/deploynow?url=https://github.com/devenkhatri/devengoratela.com_blog)
...
1. **Create a Gatsby site**
   ...
   ```sh
   npx gatsby new my-landing-page-site https://github.com/devenkhatri/devengoratela.com_blog
   ```
